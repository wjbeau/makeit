...
export const routeDefinitions = {
    ...
    career: {
        ...
        routes: [
            ...
            { path: "/finance", exact: false, main: lazy(() => import('../features/finance/FinancePage')), title: "Finances", icon: <MonetizationOn />, requiresAuth: true, showInMenu: true, disabled: true, description: 'Finance will handle expense and income tracking, tax calculations and automatic mileage logging.' },
