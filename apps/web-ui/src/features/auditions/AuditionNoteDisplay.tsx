...
import { AuditionNote } from '../../../../../libs/types/src/audition.model';
...
export const AuditionNoteDisplay = (props: {
  note: AuditionNote;
  expand?: boolean;
  highlight?: boolean;
  className?;
}) => {
  const { note, expand, highlight, className } = props;
...
export default AuditionNoteDisplay;
